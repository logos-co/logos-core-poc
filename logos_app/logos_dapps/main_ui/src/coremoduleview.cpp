...
void CoreModuleView::updatePluginList()
{
    ...
    // Use LogosAPIClient to get the list of known plugins
    LogosAPIClient api;
...
void CoreModuleView::onLoadPluginClicked()
{
    ...
    // Use LogosAPIClient to load the plugin
    LogosAPIClient api;
...
void CoreModuleView::onUnloadPluginClicked()
{
    ...
    // Use LogosAPIClient to unload the plugin
    LogosAPIClient api;
...
void CoreModuleView::onAddPluginClicked()
{
    ...
    // Use LogosAPIClient to install the plugin
    LogosAPIClient api;
